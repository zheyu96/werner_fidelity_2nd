#ifndef __WERNER_ALGO_TIME_H
#define __WERNER_ALGO_TIME_H
...
private:
    ...
    int split_dis(int s,int d,WernerAlgo_time::ZLabel& L);
    pair<double,WernerAlgo_time::ZLabel> eval_best_J(int s, int d, int t, double alp);
