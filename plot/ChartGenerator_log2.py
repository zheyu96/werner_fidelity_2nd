...
class ChartGenerator:
    ...
    def __init__(self, dataName, _Xlabel, _Ylabel, Xlabel, Ylabel, Xpow, Ypow, Ystart, Yend, Yinterval):
        ...
        plt.savefig('../data/pdf/Fie4_{}2.eps'.format(pdfName)) 
        plt.savefig('../data/pdf/{}2.jpg'.format(pdfName)) 
...
if __name__ == "__main__":
    ...
    LabelsName["fidelity_gain_log"] = "$\\log_{10}$ Expected Fidelity Sum"
    LabelsName["succ_request_cnt_log"] = "$$\\log_{10}$ \#$Accepted Requests"
